...
from utils import *
from buffer import BufferGDumbBalanced
from torch.nn import functional as F

METHODS = ['bgs']
GROUPS = torch.tensor([1,2,3,4,5,6])
...
if __name__ == '__main__':
    ...
    # source run_nn.sh 4 case_strict_main Resnet /project/continualConfoundingDataset/data_generation/output
